...
| [tailwind](https://github.com/tailwindlabs/tailwindcss) | ★26.1k | Home: [tailwind](https://tailwindcss.com/)<br>Approach: Uses atomic CSS, the css-in-js equivalent of [Tachyons](https://github.com/tachyons-css/tachyons/). / Like Tachyons, Tailwind supplies most of what a standard site would need, but makes it easy to extend. See also "otion" below. | 
...
| [otion](https://github.com/kripod/otion)⚑ | ★377 | Approach: Atomic CSS-in-JS, sort of like “automatic atomic CSS” (See Tailwind above) but based on Emotion(?)<br>"Atomic CSS-in-JS with a featherweight runtime" / Works without a framework and presumably no need for a build step. |

See this [article](https://sebastienlorber.com/atomic-css-in-js) for more information on "atomic CSS-in-JS" and to provide better understanding of Tailwind and Otion listed above.
