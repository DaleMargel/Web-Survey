...
| ------- | -----:| ----------- |
| [ReThink](https://rethinkdb.com/) | ★23.5k | **NB** This does not support REST, but I did not know where else to put it. RethinkDB a JSON database for the realtime web. RethinkDB can continuously push updated query results to applications in realtime. RethinkDB’s realtime push architecture dramatically reduces the time and effort necessary to build scalable realtime apps. |
...
| [caminte](https://github.com/biggora/caminte) | ★1.1k | | a really good database ORM that supports anything. Has a generator called [caminte generator](https://github.com/biggora/caminte-generator)★8 - supports all databases, has rest query generator, based on CanintelJS ORM . Old, not popular but quite intreguing. | 
